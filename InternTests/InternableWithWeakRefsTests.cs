...
{
    [TestFixture]
    public class InternableWithWeakRefsTests
    {
        [Test]
        public void Intern_ShouldReturnSameObject_WhenCalledWithSameParameters()
        {
            var o1 = InternableWithWeakRefs.Intern(123, "foo");
            var o2 = InternableWithWeakRefs.Intern(123, "foo");
        ...
        {
            var o1 = InternableWithWeakRefs.Intern(123, "foo");
            var o2 = InternableWithWeakRefs.Intern(234, "bar");
